...
function gmw_register_cssjs_front_end() {
	...
	wp_register_script( 'google-maps', 'http://maps.googleapis.com/maps/api/js?key='.$gmw_options['google_api'].'&sensor=false&libraries=places&region='.$gmw_options['country_code'],array(),false);
