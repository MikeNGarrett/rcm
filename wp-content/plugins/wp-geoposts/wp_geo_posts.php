<?php
/*
Plugin Name: WP GeoPosts for RCM
Plugin URI: http://fyaconiello.github.com/wp-geo-posts/
Description: A simple wordpress plugin for adding geodata to posts customized for RCM
Version: 1.1
Author: Francis Yaconiello
Author URI: http://www.yaconiello.com
Contributor: Mike Garrett
License: GPL2
*/
/*
...
if(!class_exists('WP_Geo_Posts'))
{
	class WP_Geo_Posts
	{
		...
		public function __construct()
		{
			...
			add_action('wp_enqueue_scripts',array(&$this, 'add_geo'));
		...
		public function add_geo() {
			wp_enqueue_script('wp-geo-location', plugins_url('geo.js', __FILE__));
		}
		/**
